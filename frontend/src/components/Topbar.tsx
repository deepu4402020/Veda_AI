...
export default function Topbar() {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 bg-white/95 backdrop-blur-md z-20 shrink-0 rounded-[32px] shadow-[0_12px_40px_rgba(0,0,0,0.08)] border border-gray-200/50 w-full relative">
      {/* Desktop Left */}
      <div className="hidden md:flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 text-gray-400">
           <Grip size={18} className="text-gray-400" />
           <span className="text-gray-500 font-semibold text-[15px] ml-1">{title}</span>
        </div>
      </div>
      ...
      <div className="md:hidden flex items-center gap-2">
        ...
        <span className="font-bold text-xl tracking-tight text-gray-900">{showBack ? title : 'VedaAI'}</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <button className="relative w-9 h-9 flex items-center justify-center bg-gray-50/50 hover:bg-gray-100/80 rounded-full text-gray-500 border border-gray-100/60 shadow-sm transition-all hover:scale-[1.02]">
          ...
          <div className="flex items-center gap-2 bg-gray-50/50 border border-gray-100/80 rounded-full py-1 px-1.5 pr-3 shadow-sm hover:bg-gray-50 cursor-pointer transition-all hover:scale-[1.01] hover:border-gray-200">
        ...
        <div className="md:hidden flex items-center gap-3">
          ...
          <button className="text-gray-900 p-1" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            <Menu size={24} />
          </button>
        </div>
        ...
        {mobileMenuOpen && (
          <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100 py-2 z-50 md:hidden flex flex-col overflow-hidden">
            ...
            <Link href="/library" className="px-4 py-3 text-sm text-gray-700 hover:bg-gray-50" onClick={() => setMobileMenuOpen(false)}>My Library</Link>
          </div>
        )}
      </div>
    </header>
